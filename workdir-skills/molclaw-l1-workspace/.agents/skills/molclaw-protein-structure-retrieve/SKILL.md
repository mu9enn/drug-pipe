...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__retrieve_protein_structure_by_gene_name`, `mcp__molclaw-scp__retrieve_protein_structure_by_pdb_id`, `mcp__molclaw-scp__retrieve_protein_structure_by_uniprot_id`. Retrieve and download a protein structure file (.pdb or .cif) using a gene name, UniProt ID, or PDB ID."
license: MIT license
metadata:
    skill-author: PJLab
---
