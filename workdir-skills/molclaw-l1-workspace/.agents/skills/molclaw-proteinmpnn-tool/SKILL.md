...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__proteinmpnn_tool`. Design or score protein sequences from PDB structures using a ProteinMPNN workflow wrapper."
license: MIT license
metadata:
    skill-author: PJLab
---
