...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__pred_binding_affinity_boltz2`. Predict binding affinity between target protein sequence and small molecule SMILES using Boltz-2."
license: MIT license
metadata:
    skill-author: PJLab
---
