...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__hdock_tool`. Run HDOCKlite docking for protein complexes and return run directories with ranked models."
license: MIT license
metadata:
    skill-author: PJLab
---
