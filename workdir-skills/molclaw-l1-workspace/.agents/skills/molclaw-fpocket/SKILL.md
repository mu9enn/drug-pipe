...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__fpocket_toolkit`. Use fpocket to detect binding pockets and output their detailed properties for the input protein. This offers a more concise approach to pocket identification."
license: MIT license
metadata:
    skill-author: PJLab
---
