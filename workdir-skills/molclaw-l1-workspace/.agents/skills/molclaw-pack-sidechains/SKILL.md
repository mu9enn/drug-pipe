...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__pack_sidechains`. Predicts full-atom sidechain conformations from backbone PDBs using AttnPacker for structure preparation workflows."
license: MIT license
metadata:
    skill-author: PJLab
---
