...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__base64_to_server_file`, `mcp__molclaw-scp__server_file_to_base64`. Implement data transmission between the local computer and the MCP Server using Base64 encoding"
license: MIT license
metadata:
    skill-author: PJLab
---
