...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__karmadock_tool`. Run KarmaDock graph generation and virtual screening to produce ranked ligand poses and summary metrics."
license: MIT license
metadata:
    skill-author: PJLab
---
