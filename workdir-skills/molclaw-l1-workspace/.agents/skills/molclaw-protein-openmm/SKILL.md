...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__openmm_extract_frames`, `mcp__molclaw-scp__protein_openmm_md`. Run OpenMM protein MD and extract evenly spaced trajectory frames for downstream structural analysis."
license: MIT license
metadata:
    skill-author: PJLab
---
