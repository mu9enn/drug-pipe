...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__chroma_complex`, `mcp__molclaw-scp__chroma_monomer`, `mcp__molclaw-scp__chroma_symmetry`. Chroma toolkit skill covering chroma_monomer for single-chain generation, chroma_complex for multi-chain assembly generation, and chroma_symmetry for symmetry-constrained protein design."
license: MIT license
metadata:
    skill-author: PJLab
    tool-summary: |
