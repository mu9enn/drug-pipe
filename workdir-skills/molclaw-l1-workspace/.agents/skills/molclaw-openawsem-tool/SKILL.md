...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__openawsem_sim`, `mcp__molclaw-scp__openawsem_traj_extract`. Runs OpenAWSEM simulations and extracts representative trajectory frames for downstream ensemble analysis."
license: MIT license
metadata:
    skill-author: PJLab
---
