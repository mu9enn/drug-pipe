...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__evobind_tool`. Design linear or cyclic peptide binders from receptor FASTA sequences using EvoBind2 with structured result outputs."
license: MIT license
metadata:
    skill-author: PJLab
---
