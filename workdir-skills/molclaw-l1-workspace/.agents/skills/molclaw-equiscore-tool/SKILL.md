...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__equiscore_pipeline`, `mcp__molclaw-scp__equiscore_pocket`, `mcp__molclaw-scp__equiscore_screen`. Unified EquiScore skill for pocket extraction, pocket scoring, and end-to-end docking-to-score pipeline execution."
license: MIT license
metadata:
    skill-author: PJLab
    tool-summary: |
