...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__molecule_docking_quickvina_fullprocess`. Perform molecular docking using QuickVina2-GPU between target protein structure and small molecules."
license: MIT license
metadata:
    skill-author: PJLab
---
...
step 3. Use skill **molclaw-fix-pdb** to repair the protein structure file using the settings as below.
