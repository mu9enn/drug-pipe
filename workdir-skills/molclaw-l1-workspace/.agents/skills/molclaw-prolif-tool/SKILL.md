...
description: "Use when calling these MolClaw MCP tools: `mcp__molclaw-scp__prolif_docking`, `mcp__molclaw-scp__prolif_md`, `mcp__molclaw-scp__prolif_pdb`, `mcp__molclaw-scp__prolif_protein_protein`. Unified ProLIF analysis skill covering MD trajectories, docking poses, single complex structures, and protein-protein interfaces."
license: MIT license
metadata:
    skill-author: PJLab
    tool-summary: |
...
> For PDB file inputs, it is recommended to preprocess them using `molclaw-fix-pdb` before execution.
