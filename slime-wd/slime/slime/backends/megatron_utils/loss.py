...
def policy_loss_function(
    ...
    # Entropy is only part of the objective when its coefficient is non-zero.
    # Building it unconditionally retains another full [tokens, vocab/TP]
    # softmax graph.  On long Drug-Pipe states that is tens of GiB of GPU
    # memory for a term that is multiplied by zero.
    compute_entropy = bool(args.entropy_coef)
