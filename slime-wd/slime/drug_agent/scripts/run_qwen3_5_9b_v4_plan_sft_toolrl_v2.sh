...
TOOLRL_APPLY_CHAT_TEMPLATE_KWARGS="${TOOLRL_APPLY_CHAT_TEMPLATE_KWARGS:-}"
if [[ -z "$TOOLRL_APPLY_CHAT_TEMPLATE_KWARGS" ]]; then
  TOOLRL_APPLY_CHAT_TEMPLATE_KWARGS='{"enable_thinking":false}'
fi
...
TOOLRL_COMMON=(
  ...
  APPLY_CHAT_TEMPLATE_KWARGS="$TOOLRL_APPLY_CHAT_TEMPLATE_KWARGS"
