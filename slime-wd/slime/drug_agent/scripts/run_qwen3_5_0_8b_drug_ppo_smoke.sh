...
SAVE_DIR=${SAVE_DIR:-$DRUG_AGENT_RUNS_ROOT/Qwen3.5-0.8B_drug_ppo_smoke}
SAVE_INTERVAL=${SAVE_INTERVAL:-1}
HF_CHECKPOINT=${HF_CHECKPOINT:-$DATA/Qwen3.5-0.8B}
REF_LOAD=${REF_LOAD:-$DATA/Qwen3.5-0.8B_torch_dist}
LOAD=${LOAD:-}

export DRUG_AGENT_RUN_NAME=${DRUG_AGENT_RUN_NAME:-qwen3.5_0.8b_drug_ppo_smoke}
...
PPO_ARGS=(
  ...
  --num-critic-only-steps "${NUM_CRITIC_ONLY_STEPS:-1}"
