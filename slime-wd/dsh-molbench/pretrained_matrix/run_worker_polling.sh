...
for required in \
  ...
  "$matrix_root/settings.template.yaml" "$matrix_root/molclaw.polling.cordis.patch.yml"; do
...
install -m 600 "$matrix_root/molclaw.polling.cordis.patch.yml" /root/.dsh/cordis.patch.yml
